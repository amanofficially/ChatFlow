...
import { MessageCircle, Mail, Lock, User, Eye, EyeOff, Sparkles, Zap } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-slide-up">
          ...
          <h1 className="text-3xl font-bold text-[var(--text-primary)] font-display tracking-tight">ChatFlow</h1>
          <p className="text-[var(--text-secondary)] mt-1 text-sm">
            {mode === 'login' ? 'Welcome back! Ready to connect?' : 'Join thousands of people connecting daily'}
          </p>
        </div>
        ...
        <div className="card p-8 animate-bounce-in">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-[var(--text-primary)]">Try Demo Mode</p>
              <p className="text-xs text-[var(--text-muted)]">Instant access — no signup needed</p>
            </div>
